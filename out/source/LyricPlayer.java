...
public class LyricPlayer extends PApplet {
...
public void draw() {
    ...
    if (player!=null) {
        ...
        for(int i = 0; i < fft.specSize(); i++)
            ...
            line( i+10, height-110, i+10, height - fft.getBand(i)*0.5f -110 );
            }
...
public String hms(int millis){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LyricPlayer" };
    if (passedArgs != null) {
